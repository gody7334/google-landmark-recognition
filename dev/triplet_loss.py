...
def bilinear_triplet_loss(tri_loss, bi_vector, labels, normalize_feature=False):
        if normalize_feature:
                bi_vector = normalize(bi_vector, axis=-1)
        # shape [N, N]
        dist_mat = euclidean_dist(bi_vector, bi_vector)
